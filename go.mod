module github.com/gardener/gardener-extension-shoot-agent-sandbox
...
require (
	...
	gopkg.in/yaml.v2 v2.4.0 // indirect; CVE-2022-3064: force minimum safe version (>= v2.2.4)
	gopkg.in/yaml.v3 v3.0.1 // indirect; CVE-2022-28948: force minimum safe version (>= v3.0.1)
